<img width="1713" height="1106" alt="image" src="https://github.com/user-attachments/assets/14f6faf1-44d2-46ac-9302-bbcefcaf1b4a" />## LAB DESCRIPTION
...
<img width="1713" height="1106" alt="image" src="https://github.com/user-attachments/assets/28b2bd3c-5327-4b87-b605-97e1e851adf0" />

With the final HTML stored on the exploit server:
1. Confirm that when you **View Exploit** while logged in as `wiener`, clicking "Click me" deletes your own account (on the lab's victim simulation).

2. Once alignemnt and behaviour are correct, use **Deliver exploit to victim** from the exploit server interface.
